...
requirements = st.text_area(
    "シフトのルールを入力してください",
    value="・来週の月曜日〜金曜日の5日間のシフトを作成してください。各人は週のどこかの日のどこかの時間帯にに一回のみ入れてください。入れる人が二人に満たない場合削除して構いません。・各日、できる限り2名以上配置してください。一名しか割り当てられない場合削除してください。・午前、午後、夜間に分けて作成してください。同じ人が同じ日の複数の時間帯に入っている場合、もっとも人数が多い時間帯を優先し、他は削除してください。
・入力が「どこでも」の場合、三宿・平和島・浜町の中で、その日の同じ時間帯に他の人が多くいる場所に割り当ててください。・「なるべくどこがいい」という希望がある場合は優先してください。",
    height=150
)
